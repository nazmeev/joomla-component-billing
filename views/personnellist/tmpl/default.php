...
<div class="panel panel-default">
  <div class="panel-body">
    <form action="<?php echo JRoute::_('index.php?option=com_billing&view=personnels');?>" method="POST" name="form-search">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-right">
                <a class="btn btn-info" href="<?php echo JRoute::_('index.php?option=com_billing&controller=personnel&view=personnel');?>" ><?php echo JText::_('CREATE'); ?></a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
