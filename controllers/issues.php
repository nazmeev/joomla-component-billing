...
class BillingControllerIssues extends JControllerLegacy{
    function issues(){
        ...
        $total = $_issue->getCountIssues($filters, $search);

        jimport('joomla.html.pagination');
        $pagination = new JPagination($total, $limitstart, $limit);
        $pagenav = $pagination->getPagesLinks();

        $rows = $_issue->getAllIssues($filters, $orderby, $order, $limitstart, $limit, $search);
        ...
        $view = $this->getView('issuelist','html');
